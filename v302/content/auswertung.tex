...
Das Minimum der Brückenspannung wurde hier für die Widerstände $R_3=\qty{554}{\ohm}$ und $\qty{446}{\ohm}$ gefunden.
Der Quotient der Werte beträgt $\frac{R_3}{R_4}=1,242\pm0,006$.
$R_x$ hat mit den Gleichungen \ref{eqn:widerstand} und \ref{eqn:fehlerfortpflanzung} den Wert $R_x=\qty{412(13)}{\ohm}$.
Für $L_x$ ergibt sich mit \ref{eqn:widerstand} $L_2=\qty{34}{\milli\henry}$ mit dem Fehler $\sqrt{\Bigl(\frac{R_3}{R_4}\Bigr)^2 (\increment L_2)^2+L_2^2 \Bigl(\increment \frac{R_3}{R_4}\Bigr)^2}$.
Mit Einsetzen der Werte erhält man $L_x=\qty{34,16(1,04)}$.
...
Es folgt, dass $R_13=\qty{366.687(11.130)}{\ohm}$ ist. Für die Induktivität gilt jetzt Gleichung \ref{eqn:maxwell}. Dabei ist $C_4=\qty{450(13.5)}{\nano\Farad}$
