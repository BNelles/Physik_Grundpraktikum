\section{Diskussion}
    ...
    \subsection{Vergleich der Induktiven und Maxwell Brückenschaltung}
    ...
    Wie \ref{fig:klirr_mod} modellhaft zeigt, hat ein solch großer Wert von $k$ einen signifikanten Einfluss auf den Spannungsverlauf, einen
