...
\begin{table}
  ...
  Zudem wurden aus diesen Werten Ggenstands- und Bildweite berechnet. Die Ungenauigkeit aller Werte beträgt $\pm \qty{0.1}{\centi\meter}}$.
  \label{tab:brenn}
  \centering
  \begin{tblr}{
    colspec{S[table-format=1.1] S[table-format=1.1]};
