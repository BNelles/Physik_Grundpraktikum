...
Anhand der Formeln \ref{eqn:abbe} ergibt sich das die gemittelte Brennweite der kombinierten Linsen $f_A=\qty{20.5(1.0)}{\centi\meter}$ beträgt. Die Hauptebene $H'$ befindet sich $\qty{7.24(1.32)}{\centi\meter}$ vom Referenzpunkt
...
Aus Diesen und den Werten $f_1=\qty{-10}{\centi\meter}$ und $f_2=\qty{10}{\centi\meter}$ergibt sich 
\begin{equation*}
  D=\frac{1}{f_1}+\frac{1}{f_2}
\end{equation*} 
.
Das eingesetzt in Formel \ref{eqn:Brechkraft} ergibt den Wert $f_At=\qty{0}{\centi\meter}$,
