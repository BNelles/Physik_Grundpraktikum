...
\label{sec:Theorie}
    ...
    Ein Effekt der bei Linsen auftritt, der beachtet werden muss, ist die chromatische Aberration. Diese beschreibt eine Verzerrung des Bildes, dessen Licht durch eine Linse läuft, aufgrund der verschiedenen Wellenlängen, die unterschiedlich gebrochen werden an dieser.
