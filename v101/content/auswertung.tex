...
\label{sec:Auswertung}
  ...
  oder
  \begin{equation}
    T^2=\frac{8m\pi^2}{D}a^2+\frac{\pi^2}{D}(4I_D+2mR^2+\frac{2}{3}mh^2)
  \end{equation} 
  In \ref{fig:plot} wird $T^2$ zu $a^2$ aufgetragen. Die Steigung der Regressionsgerade beträgt dabei 
  $\qty{717,69(4.45)}{\second\squared \per \meter\squared}$ und der $\symup{T}^2$-Achsenabschnitt beträgt $\qty{6,04(0.21)}{\second\squared}$.
  ...
  \subsection{Trägheitsmoment der Puppe}
   ...
   \begin{table}
    ...
    \begin{tblr}{
      ...
      \toprule
        n & 5T_90 \mathbin{/} [\unit{\second}] & 5T_120 \mathbin{/} [\unit{\second}] \\
      \midrule
      1 & 3.00    & 2.78\\  
      2 & 2.90  & 3.00\\
      3 & 2.87 &  2.94\\
    ...
    Die Mittlere Periodendauer ist $5T=\qty{2.961}{\second}$ % Fehler fehlen noch
    ...
    Die Mittlere Periodendauer ist $5T=\qty{4.023}{seconds}$ %% Fehler fehlen noch
    ...
    \subsubsection{Berechnung des Trägheismomentes}
    ...
    Hier wird die Puppe so aufgestellt, wie in (...) gezeigt.%% Hier bitte Bild 1 einfügen
    ...
    Jetzt wird die Puppe wie in (...) aufgestellt.%% Hier bitte Bild 2 einfügen
