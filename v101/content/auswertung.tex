...
\label{sec:Auswertung}
  ...
  \end{equation}
  ,welches aus den Formeln \ref{eqn:Schwingungsdauer}, \ref{eqn:Trägheit_Zyl_2} und \ref{eqn:Steiner} bestimmt werden kann
  kann das Eigenträgheitsmoment der Drillachse bestimmt werden. 
  ...
  \end{equation}
  Da der Radius der beiden Zylinder nicht bekannt ist, er sich aber zwischen 0$\unit{\centi\meter}$ und 10$\unit{\centi\meter}$
  befinden muss,
